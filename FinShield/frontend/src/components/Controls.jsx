...
export default function Controls({ loading, onStart, onReset, canStart = true }) {
  return (
    <div className="relative z-10 mt-8 flex flex-wrap items-center gap-4 text-sm tracking-[0.2em] text-white/90">
      <button
        type="button"
        onClick={onStart}
